...
output_affix="/srv/beegfs02/scratch/data_shichen/data/evennicer-slam/EvenNICER-SLAM/output"
...
if [ -z "$SLURM_ARRAY_TASK_ID" ]; then
    python -W ignore run_posegrid.py configs/${dataset}/${scene_name}.yaml --output ${output_affix}/${method}/${dataset}/${scene_name}-${run_suffix}
