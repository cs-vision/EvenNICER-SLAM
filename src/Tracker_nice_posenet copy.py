...
class Tracker(object):
    ...
    def run(self):
        ...
        for init_i in range(0): # TODO : 0→50 にする
        ...
        for idx, gt_color, gt_depth, gt_c2w in pbar:
            ...
            if idx == 0 or self.gt_camera:
                ...
                #self.optimizer = torch.optim.Adam([dict(params=self.TQNet.parameters(), lr = self.cam_lr*1)]) 
                ...
                # estimated_correct_cam_trans, estimated_new_cam_quad = self.TQNet.forward(idx_tensor)
                #estimated_correct_cam_trans = estimated_correct_cam_trans.unsqueeze(0)
                ...
                for cam_iter in range(self.num_cam_iters):
                    ...
                    #     camera_tensor, gt_color, gt_depth, self.tracking_pixels, self.optimizer)
                    ...
                    if loss < current_min_loss:
                        ...
                        candidate_cam_tensor = camera_tensor.clone().detach().to(device)
